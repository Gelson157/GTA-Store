...
addon = xbmcaddon.Addon('plugin.video.On Demand Play 2.0')
...
communityfiles = os.path.join(profile, 'On Demand Play 2.0')
...
CHBase = 'http://pastebin.com/raw/B51X8AZa'
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.On Demand Play 2.0-%s]: %s" %(addon_version, string))
